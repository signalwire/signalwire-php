...
/**
 * CxmlScripts REST resource (fabric API).
 */
class CxmlScripts extends \SignalWire\REST\FabricResourcePUT
{
    public function __construct(\SignalWire\REST\HttpClient $http)
    {
        parent::__construct($http, '/api/fabric/resources/cxml_scripts');
    }
}
