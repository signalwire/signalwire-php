 ...
 * tree is spec-derived (porting-sdk/rest-apis x-sdk-* markup), regenerated by
 ...
 * spec-derivable: credentials/auth, HTTP-layer construction, and the still-hand
 * ``compat`` namespace.
 */
class RestClient
{
    ...
    // Compat (Twilio-compatible LaML) stays hand-written — not spec-derived.
    ...
    // -----------------------------------------------------------------
    // Hand-written namespace accessor (not spec-derived)
    // -----------------------------------------------------------------
